...
/* ═══════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════ */
const umrahPackages = [
  { id: 1, img: 'https://images.unsplash.com/photo-1591604466107-ec97de577aff?w=600&q=80', nights: '14 Nights', title: 'Economy Umrah Package', desc: 'Comfortable economy-class experience with group accommodation near Haram in Makkah and Madinah.', hotel: '4-Star Hotel', meals: 'Breakfast Included', transport: 'Group Transport', visa: 'Visa Included', price: '$650', per: '/person', rating: '4.8', category: 'economy', popular: false },
  { id: 2, img: 'https://images.unsplash.com/photo-1564769625905-50e93615e769?w=600&q=80', nights: '21 Nights', title: 'Premium Umrah Package', desc: 'Upgraded rooms 50m from Haram, direct flights, full visa support, and a dedicated group guide.', hotel: '5-Star Hotel', meals: 'Full Board', transport: 'Private Transport', visa: 'Visa Included', price: '$1,350', per: '/person', rating: '4.9', category: 'premium', popular: true },
  { id: 3, img: 'https://images.unsplash.com/photo-1542816417-0983c9c9ad53?w=600&q=80', nights: '10 Nights', title: 'Budget Umrah Package', desc: 'Affordable yet complete Umrah experience with group transport and visa processing included.', hotel: '3-Star Hotel', meals: 'Bed & Breakfast', transport: 'Group Transport', visa: 'Visa Included', price: '$430', per: '/person', rating: '4.7', category: 'budget', popular: false },
  { id: 4, img: 'https://images.unsplash.com/photo-1588416936097-41850ab3d86d?w=600&q=80', nights: '28 Nights', title: 'Ramadan Special Package', desc: 'Spend Ramadan in the Holy Lands with premium Haram-facing rooms, Iftar & Suhoor.', hotel: '5-Star Haram View', meals: 'All Inclusive', transport: 'Private Transport', visa: 'Visa + Insurance', price: '$1,950', per: '/person', rating: '5.0', category: 'premium', popular: true },
  { id: 5, img: 'https://images.unsplash.com/photo-1580418827493-f2b22c0a76cb?w=600&q=80', nights: '7 Nights', title: 'Express Umrah Package', desc: 'Short stay covering all rituals with 3-night Makkah and 4-night Madinah stays.', hotel: '4-Star Hotel', meals: 'Breakfast Included', transport: 'Group Transport', visa: 'Visa Included', price: '$340', per: '/person', rating: '4.6', category: 'budget', popular: false },
  { id: 6, img: 'https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=600&q=80', nights: '14 Nights', title: 'Family Umrah Package', desc: 'Spacious family suites, kid-friendly amenities, and dedicated family concierge.', hotel: '5-Star Suite', meals: 'Full Board', transport: 'Private Van', visa: 'Family Visa Deal', price: '$1,150', per: '/person', rating: '4.9', category: 'economy', popular: true },
];
...
/* ═══════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════ */
const hotels = [
  { id: 1, img: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&q=80', title: 'Swissotel Al Maqam', location: 'Makkah, Saudi Arabia', distance: '50m from Haram', stars: 5, rating: '4.9', reviews: 2340, price: '$160', per: '/night', category: 'makkah', featured: true, amenities: ['wifi', 'pool', 'spa', 'restaurant', 'parking', 'gym'] },
  { id: 2, img: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?w=600&q=80', title: 'Hilton Suites Makkah', location: 'Makkah, Saudi Arabia', distance: '200m from Haram', stars: 5, rating: '4.8', reviews: 1856, price: '$115', per: '/night', category: 'makkah', featured: false, amenities: ['wifi', 'restaurant', 'parking', 'gym'] },
  { id: 3, img: 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=600&q=80', title: 'Pullman Zamzam Makkah', location: 'Makkah, Saudi Arabia', distance: '100m from Haram', stars: 5, rating: '4.7', reviews: 1420, price: '$135', per: '/night', category: 'makkah', featured: true, amenities: ['wifi', 'restaurant', 'spa', 'parking'] },
  { id: 4, img: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=600&q=80', title: 'The Oberoi Madinah', location: 'Madinah, Saudi Arabia', distance: '150m from Masjid Nabawi', stars: 5, rating: '4.9', reviews: 980, price: '$150', per: '/night', category: 'madinah', featured: true, amenities: ['wifi', 'pool', 'spa', 'restaurant', 'parking', 'gym'] },
  { id: 5, img: 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=600&q=80', title: 'Shaza Al Madina', location: 'Madinah, Saudi Arabia', distance: '300m from Masjid Nabawi', stars: 4, rating: '4.6', reviews: 760, price: '$80', per: '/night', category: 'madinah', featured: false, amenities: ['wifi', 'restaurant', 'parking'] },
  { id: 6, img: 'https://images.unsplash.com/photo-1445019980597-93fa8acb246c?w=600&q=80', title: 'Crowne Plaza Madinah', location: 'Madinah, Saudi Arabia', distance: '500m from Masjid Nabawi', stars: 4, rating: '4.5', reviews: 640, price: '$65', per: '/night', category: 'madinah', featured: false, amenities: ['wifi', 'pool', 'restaurant', 'parking', 'gym'] },
  { id: 7, img: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=600&q=80', title: 'Makkah Clock Royal Tower', location: 'Makkah, Saudi Arabia', distance: '80m from Haram', stars: 5, rating: '4.8', reviews: 3100, price: '$200', per: '/night', category: 'makkah', featured: true, amenities: ['wifi', 'pool', 'spa', 'restaurant', 'parking', 'gym'] },
  { id: 8, img: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=600&q=80', title: 'Anwar Al Madinah Movenpick', location: 'Madinah, Saudi Arabia', distance: '200m from Masjid Nabawi', stars: 5, rating: '4.7', reviews: 1150, price: '$100', per: '/night', category: 'madinah', featured: false, amenities: ['wifi', 'restaurant', 'spa', 'parking'] },
];
...
/* ═══════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════ */
const flightRoutes = [
  { id: 1, from: { code: 'ISB', name: 'Islamabad' }, to: { code: 'JED', name: 'Jeddah' }, duration: '4h 30m', price: '$305', airline: 'Saudi Airlines', color: '#006633' },
  { id: 2, from: { code: 'LHR', name: 'London' }, to: { code: 'JED', name: 'Jeddah' }, duration: '6h 15m', price: '$520', airline: 'British Airways', color: '#2e5c9a' },
  { id: 3, from: { code: 'DXB', name: 'Dubai' }, to: { code: 'MED', name: 'Madinah' }, duration: '2h 45m', price: '$185', airline: 'Emirates', color: '#d71920' },
  { id: 4, from: { code: 'KHI', name: 'Karachi' }, to: { code: 'JED', name: 'Jeddah' }, duration: '3h 50m', price: '$280', airline: 'PIA', color: '#006838' },
  { id: 5, from: { code: 'YYZ', name: 'Toronto' }, to: { code: 'JED', name: 'Jeddah' }, duration: '12h 30m', price: '$750', airline: 'Turkish Airlines', color: '#c8102e' },
  { id: 6, from: { code: 'LHE', name: 'Lahore' }, to: { code: 'MED', name: 'Madinah' }, duration: '4h 10m', price: '$295', airline: 'Flynas', color: '#7b2d8e' },
];
